      ...
      <div className="regis-card">
        ...
        <form className="regis-form" onSubmit={submit} noValidate>
          <div className="regis-grid">
            ...
            <div className="regis-field regis-field-col2">
              <label className="regis-label">Avatar</label>
              <input
                id="regis-file"
                type="file"
                accept="image/*"
                className="regis-file"
                onChange={onFileChange}
              />
              <label htmlFor="regis-file" className="regis-file-trigger">
                {fileName ? `Archivo: ${fileName}` : "Seleccionar imagen"}
              </label>
              {preview && (
                <div className="regis-preview">
